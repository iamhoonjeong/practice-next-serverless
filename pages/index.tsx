  ...
  return (
    <div className="bg-slate-400 py-20 px-20 grid gap-10 min-h-screen">
      <div className="bg-white p-6 rounded-3xl shadow-xl">
        ...
        <button className="mt-5 bg-blue-500 text-white p-3 text-center rounded-xl cursor-pointer w-full mx-auto hover:bg-teal-500 hover:text-black active:bg-yellow-500 focus:bg-red-500">
          Checkout
        </button>
      </div>
      <div className="bg-white overflow-hidden rounded-3xl shadow-xl">
        ...
        <div className="rounded-3xl p-6 bg-white relative -top-5">
          ...
          <div className="relative flex flex-col items-center -mt-10 -mb-5">
            <span className="text-ls font-medium">Tony Molloy</span>
